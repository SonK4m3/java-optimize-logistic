package sonnh.opt.opt_plan.constant.common;
...
public class Api {
	...
	public static final String PRODUCT_ROUTE = API_BASE_URL + "/products";
	public static final String CATEGORY_ROUTE = API_BASE_URL + "/categories";
	public static final String DRIVER_ROUTE = API_BASE_URL + "/drivers";
	public static final String VEHICLE_ROUTE = API_BASE_URL + "/vehicles";
